...
namespace COG.Math
{
    ...
    /// </summary>
    public struct Tuple2<A, B> : IEquatable<Tuple2<A, B>>
    {
        ...
        {
            if (other is Tuple2<A, B>)
            {
                return this.Equals((Tuple2<A, B>)other);
            }
            return false;
        }
    ...
    public struct Tuple2<A, B, C> : IEquatable<Tuple2<A, B, C>>
    {
        #region Fields and Properties
        ...
        public bool Equals(Tuple2<A, B, C> other)
        {
            return First.Equals(other.First)
                   && Second.Equals(other.Second)
        ...
        public override bool Equals(object other)
        {
            if (other is Tuple2<A, B, C>)
            {
                return this.Equals((Tuple2<A, B, C>)other);
            }
            return false;
        }
    ...
    public struct Tuple2<A, B, C, D> : IEquatable<Tuple2<A, B, C, D>>
    {
        #region Fields and Properties
        ...
        public Tuple2(A first, B second, C third, D fourth)
        {
            this.First = first;
            this.Second = second;
            this.Third = third;
        ...
        public bool Equals(Tuple2<A, B, C, D> other)
        {
            return First.Equals(other.First)
                   && Second.Equals(other.Second)
                   && Third.Equals(other.Third);
        ...
        public override bool Equals(object other)
        {
            if (other is Tuple2<A, B, C, D>)
            {
                return this.Equals((Tuple2<A, B, C, D>)other);
            }
            return false;
        }
