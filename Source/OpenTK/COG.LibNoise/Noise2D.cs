...
namespace COG.LibNoise
{
    ...
    public class Noise2D : IDisposable
    {
        ...
        public Texture2D GetNormalMap(string module, string name, float scale)
        {
            ...
            return new Texture2D(new AssetUri(module, "texture", name), TextureData2D.FromColorArray(data, m_width, m_height));
        }
        ...
        public Texture2D GetTexture(string module, string name)
        {
            return this.GetTexture(module, name, Gradient.Grayscale);
        }
        ...
        /// <returns>The created texture map.</returns>
        public Texture2D GetTexture(string module, string name, Gradient gradient)
        {
            return this.GetTexture(module, name, ref gradient);
        }
        ...
        /// <param name="gradient">The gradient to color the texture map with.</param>
        /// <returns>The created texture map.</returns>
        public Texture2D GetTexture(string module, string name, ref Gradient gradient)
        {
            Color[] data = new Color[this.m_width * this.m_height];
            int id = 0;
            for (int y = 0; y < this.m_height; y++)
